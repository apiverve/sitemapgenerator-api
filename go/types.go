...
// Request contains the parameters for the Sitemap Generator API.
//
// Parameters:
...
type Request struct {
	...
	BaseUrl string `json:"baseUrl,omitempty"` // Optional
	ChangeFreq string `json:"changeFreq,omitempty"` // Optional
	Priority float64 `json:"priority,omitempty"` // Optional
	IncludeLastMod bool `json:"includeLastMod,omitempty"` // Optional
}
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		...
		"changeFreq": {Type: "string", Required: false},
		"priority": {Type: "number", Required: false, Min: float64Ptr(0), Max: float64Ptr(1)},
		"includeLastMod": {Type: "boolean", Required: false},
	}
...
// ResponseData contains the data returned by the Sitemap Generator API.
