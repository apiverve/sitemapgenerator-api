...
```gradle
dependencies {
    implementation 'com.github.apiverve:sitemapgenerator-api:1.1.12'
}
```
...
```java
import com.apiverve.sitemapgenerator.SitemapGeneratorAPIClient;
import com.apiverve.sitemapgenerator.APIResponse;
import com.apiverve.sitemapgenerator.APIException;

// Initialize the client
SitemapGeneratorAPIClient client = new SitemapGeneratorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/sitemapgenerator](https://docs.apiverve.com/ref/sitemapgenerator)
...
- **Documentation:** [https://docs.apiverve.com/ref/sitemapgenerator](https://docs.apiverve.com/ref/sitemapgenerator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/sitemapgenerator-api/issues)
