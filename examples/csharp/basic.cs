...
{
    class SitemapGeneratorExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/sitemapgenerator";

        /// <summary>
        /// Make a POST request to the Sitemap Generator API
        /// </summary>
        static async Task<JsonDocument> CallSitemapGeneratorAPI()
        {
            try
            {
                ...
                // Request body
                var requestBody &#x3D; new { urls &#x3D; /,/about,/contact,[object Object],[object Object], baseUrl &#x3D; &quot;https://example.com&quot;, changeFreq &#x3D; &quot;weekly&quot;, priority &#x3D; 0.5, includeLastMod &#x3D; true };
        ...
        {
            Console.WriteLine("📤 Calling Sitemap Generator API...\n");

            var result = await CallSitemapGeneratorAPI();
