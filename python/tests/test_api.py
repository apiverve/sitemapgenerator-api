...
class TestSitemapgeneratorAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = SitemapgeneratorAPIClient(self.api_key)

    @patch('apiverve_sitemapgenerator.apiClient.requests.get')
