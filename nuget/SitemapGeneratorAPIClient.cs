...
namespace APIVerve.API.SitemapGenerator
{
    ...
    /// <summary>
    /// Client for the SitemapGenerator API
    /// </summary>
    public class SitemapGeneratorAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/sitemapgenerator";
        ...
        {
            { "urls", new ValidationRule { Type = "array", Required = true, Format = "url" } },
            { "baseUrl", new ValidationRule { Type = "string", Required = false, Format = "url" } },
            { "changeFreq", new ValidationRule { Type = "string", Required = false } },
            { "priority", new ValidationRule { Type = "number", Required = false, Min = 0, Max = 1 } },
            { "includeLastMod", new ValidationRule { Type = "boolean", Required = false } }
        };
        ...
        public SitemapGeneratorAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public SitemapGeneratorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public SitemapGeneratorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, SitemapGeneratorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(SitemapGeneratorQueryOptions options)
        {
        ...
        public ResponseObj Execute(SitemapGeneratorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(SitemapGeneratorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(SitemapGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(SitemapGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(SitemapGeneratorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(SitemapGeneratorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(SitemapGeneratorQueryOptions options)
        {
